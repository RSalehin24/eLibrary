...
DEMO_USER_EMAIL = env("DEMO_USER_EMAIL", "demo_user.library@rsalehin24.me")
DEMO_USER_PASSWORD = env("DEMO_USER_PASSWORD", "YCDqgDw9CwxPprt")
...
PROCESSING_CHECKPOINT_REDIS_URL = env(
    "PROCESSING_CHECKPOINT_REDIS_URL",
    CELERY_BROKER_URL,
)
...
CELERY_PROCESSING_CONCURRENCY = int(env("CELERY_PROCESSING_CONCURRENCY", "5"))
